...
func IsSameContent(title string, titleAle string, cfg ParserConfigGet, htmlSize int, lines int, structureSize int, fakeStructureSize int, content string) bool{
